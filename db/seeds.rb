...
# end
#Seat---------------------
Trip.create! time_start: Time.now + 3600,
             time_finish: Time.now + 7*3600,
             city_start: "Hà Nội",
...
Trip.create(time_start: Time.now() + 1.hour, time_finish: Time.now() + 7.hour, city_start: "Hà Nội", city_finish: "Nghệ An", coach_id: 2, fare: 200000)